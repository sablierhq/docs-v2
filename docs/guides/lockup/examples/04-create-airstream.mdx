...
import { ISablierMerkleLL } from "@sablier/v2-periphery/src/interfaces/ISablierMerkleLL.sol";
...
- [`createMerkleLL`](/reference/airdrops/contracts/contract.SablierMerkleFactory#createmerklell): uses Lockup Linear
  streams.
- [`createMerkleLT`](/reference/airdrops/contracts/contract.SablierMerkleFactory#createmerklelt): uses Lockup Tranched
  streams.
...
[MerkleLockup.ConstructorParams](/reference/airdrops/contracts/types/library.MerkleBase#constructorparams) as the shared
...
[clawback](/reference/airdrops/contracts/abstracts/abstract.SablierMerkleBase#clawback) any unclaimed assets from the
campaign.
