...
## Airdrops Deployment Guide

#### Step 1: Clone the [Airdrops repo](https://github.com/sablier-labs/airdrops) and switch to the release branch
...
#### Step 4: Run the following command to deploy all periphery contracts
